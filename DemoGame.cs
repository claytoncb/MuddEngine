...
namespace MuddEngine
{
    class DemoGame : MuddEngine.MuddEngine
    {
        ...
        public override void OnLoad()
        {
            ...
            light1 = new LightSource(new Vector3(0,0,120f), 2400f,1.0f, Raylib_cs.Color.Blue, "BlueLight");
            AddLight(light1);
            ceilingLight1 = new Sprite2D(new Vector3(0,0, 50f), "CeilingLight1",1, 0f,"Sprite");

            light2 = new LightSource(new Vector3(512,0,120f), 800f, 1.0f, Raylib_cs.Color.Red, "RedLight");
            AddLight(light2);
            //ceilingLight2 = new Sprite2D(new Vector3(512,0, 220f), "CeilingLight2",1, 0f,"Sprite");

            light3 = new LightSource(new Vector3(-512,0,120f), 800f, 1.0f, Raylib_cs.Color.Green, "GreenLight");
            AddLight(light3);
            //ceilingLight3 = new Sprite2D(new Vector3(-512,0, 220f), "CeilingLight3",1, 0f,"Sprite");

            light4 = new LightSource(new Vector3(-1024,0,120f), 800f, 1.0f, Raylib_cs.Color.White, "WhiteLight");
            AddLight(light4);
